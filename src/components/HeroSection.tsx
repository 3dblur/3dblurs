  ...
  return (
    ...
    >
      <div className="container px-6 mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="screen-border p-8 inline-block max-w-2xl animate-on-scroll opacity-0 translate-y-10 transition-all duration-700 delay-300">
            <span></span>
            <h2 className="text-lg md:text-xl font-orbitron text-hackathon-terminal-green mb-4">
            ...
            <h3 className="font-mono text-sm md:text-base text-hackathon-terminal-green">
              {typewriterText}<span className="cursor-blink text-hackathon-terminal-green">_</span>
            </h3>
          </div>
          ...
          <div className="mt-12 animate-on-scroll opacity-0 translate-y-10 transition-all duration-700 delay-400 flex flex-wrap justify-center gap-6 mb-12">
            <div className="flex items-center text-sm md:text-base text-white/80 font-mono">
              <MapPin size={18} className="text-hackathon-terminal-green mr-2" />
              <span>VIRTUAL EVENT</span>
            </div>
            <div className="flex items-center text-sm md:text-base text-white/80 font-mono">
              <Calendar size={18} className="text-hackathon-terminal-green mr-2" />
              <span>DATE: TBD</span>
            </div>
            <div className="flex items-center text-sm md:text-base text-white/80 font-mono">
              <Rocket size={18} className="text-hackathon-terminal-green mr-2" />
              <span>PRIZES: $1M+</span>
            </div>
          </div>
          ...
          <div className="mt-24 relative">
            <div className="overflow-hidden rounded-full w-60 h-60 mx-auto relative border border-hackathon-terminal-green/30">
              <img 
              ...
              <div className="absolute inset-0 border-2 border-hackathon-terminal-green/20 rounded-full"></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-3/4 h-3/4 border border-hackathon-terminal-green/40 rounded-full animate-pulse-slow"></div>
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-1/2 h-1/2 border border-hackathon-terminal-green/60 rounded-full animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-1/4 h-1/4 border border-hackathon-terminal-green/80 rounded-full animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
              </div>
            </div>

            {/* Data points around the globe */}
            <div className="absolute top-1/4 -left-2 text-[8px] font-mono text-hackathon-terminal-green/70">DATA POINT A</div>
            <div className="absolute bottom-1/4 -right-2 text-[8px] font-mono text-hackathon-terminal-green/70">DATA POINT B</div>
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 text-[8px] font-mono text-hackathon-terminal-green/70">ORIGIN POINT</div>
          </div>
        </div>
      </div>
      
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a href="#about" className="flex flex-col items-center text-hackathon-terminal-green/60 hover:text-hackathon-terminal-green transition-colors duration-200">
      ...
      <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-left opacity-70">
        <div className="font-mono text-[10px] text-hackathon-terminal-green space-y-1">
